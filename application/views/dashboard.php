					...
					<div class="portlet solid bordered light-grey">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="<?php echo base_url(); ?>public/assets/img/loading.gif" alt="loading"/>
							</div>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="<?php echo base_url(); ?>public/assets/img/avatar.png" class="img-responsive"/>
													<div class="details">
														<div>
															<a href="#">
																 Robert Nilson
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="<?php echo base_url(); ?>public/assets/img/avatar1.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="<?php echo base_url(); ?>public/assets/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="<?php echo base_url(); ?>public/assets/img/avatar3.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
